...
//     C++: 0.1.5
#ifndef  GOOGLE_PUBSUB_API_LIST_TOPICS_RESPONSE_H_
#define  GOOGLE_PUBSUB_API_LIST_TOPICS_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class ListTopicsResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ListTopicsResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ListTopicsResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_pubsub_api::ListTopicsResponse</code>
   */
  const char* GetTypeName() const {
    return "google_pubsub_api::ListTopicsResponse";
  }
   ...
   */
  const client::JsonCppArray<Topic > get_topics() const;
   ...
   */
  client::JsonCppArray<Topic > mutable_topics();

 private:
  void operator=(const ListTopicsResponse&);
};  // ListTopicsResponse
}  // namespace google_pubsub_api
#endif  // GOOGLE_PUBSUB_API_LIST_TOPICS_RESPONSE_H_
