...
//     C++: 0.1.5
#ifndef  GOOGLE_PUBSUB_API_TEST_IAM_PERMISSIONS_RESPONSE_H_
#define  GOOGLE_PUBSUB_API_TEST_IAM_PERMISSIONS_RESPONSE_H_
...
class TestIamPermissionsResponse : public client::JsonCppData {
 public:
   ...
   *
   * @return <code>google_pubsub_api::TestIamPermissionsResponse</code>
   */
  const char* GetTypeName() const {
    return "google_pubsub_api::TestIamPermissionsResponse";
  }
...
#endif  // GOOGLE_PUBSUB_API_TEST_IAM_PERMISSIONS_RESPONSE_H_
