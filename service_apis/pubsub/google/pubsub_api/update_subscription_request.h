...
//     C++: 0.1.5
#ifndef  GOOGLE_PUBSUB_API_UPDATE_SUBSCRIPTION_REQUEST_H_
#define  GOOGLE_PUBSUB_API_UPDATE_SUBSCRIPTION_REQUEST_H_
 ...
 * @ingroup DataObject
 */
class UpdateSubscriptionRequest : public client::JsonCppData {
 public:
  /**
   ...
   */
  static UpdateSubscriptionRequest* New();
   ...
   */
  explicit UpdateSubscriptionRequest(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit UpdateSubscriptionRequest(Json::Value* storage);
   ...
   *
   * @return <code>google_pubsub_api::UpdateSubscriptionRequest</code>
   */
  const char* GetTypeName() const {
    return "google_pubsub_api::UpdateSubscriptionRequest";
  }
 ...
 private:
  void operator=(const UpdateSubscriptionRequest&);
};  // UpdateSubscriptionRequest
}  // namespace google_pubsub_api
#endif  // GOOGLE_PUBSUB_API_UPDATE_SUBSCRIPTION_REQUEST_H_
